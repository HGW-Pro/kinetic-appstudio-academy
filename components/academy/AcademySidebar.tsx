...
type IconName = "home" | "path" | "courses" | "challenge" | "labs" | "glossary" | "progress" | "admin";
...
export default function AcademySidebar() {
  ...
  return (
    <aside className="hidden w-60 shrink-0 border-r border-[var(--border)] bg-[var(--surface)] lg:flex lg:flex-col">
      <nav aria-label="Academy navigation" className="flex flex-1 flex-col gap-1 px-3 py-5">
